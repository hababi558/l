...
function draw(){
 ...
 if (ball2.isTouching(w1)){
    ball2.x=260
    ball2.y=250
 }

 if (ball2.isTouching(w2)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w3)){
  ball2.x=260
  ball2.y=250
}
if (ball.isTouching(w4)){
...
if (ball2.isTouching(w5)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w6)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w7)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w8)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w9)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w10)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w11)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w12)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w13)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w14)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w15)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w16)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w17)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w18)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w19)){
  ball2.x=260
  ball2.y=250
}
if (ball2.isTouching(w20)){
  ball2.x=260
  ball2.y=250
}
